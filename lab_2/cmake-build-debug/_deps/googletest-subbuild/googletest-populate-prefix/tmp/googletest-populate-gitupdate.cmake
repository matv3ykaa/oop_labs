...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    ...
    OUTPUT_STRIP_TRAILING_WHITESPACE
    # Don't tests for an error. If this isn't a branch, we get a non-zero error
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/matveyd/CLionProjects/OOP/Lab2/OOP_MAI-lab2_oop_mai/cmake-build-debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/matveyd/CLionProjects/OOP/Lab2/OOP_MAI-lab2_oop_mai/cmake-build-debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
